...
@Schema(description = "Represents a NS identifier deletion notification, which informs the receiver of the deletion of a new NS instance resource and the associated NS instance identifier.")
public class NsIdentifierDeletionNotification implements LifecycleManagementNotification {
    ...
    private String id;
    @Schema(name = "Notification Type", required = true, description = "Discriminator for the different notification types. Shall be set to \"NsIdentifierDeletionNotification\" for this notification type.")
