...
@ApiModel(description = "Represents a NS identifier creation notification, which informs the receiver of the creation of a new NS instance resource and the associated NS instance identifier.")
public class NsIdentifierCreationNotification implements LifecycleManagementNotification {
    ...
    private String id;
    @ApiModelProperty(name = "Notification Type", required = true, notes = "Discriminator for the different notification types. Shall be set to \"NsIdentifierCreationNotification\" for this notification type.")
