...
@Schema(description = "Represents a PNFD management notification, which informs the receiver of the successful on-boarding of a PNFD.")
public class PnfdOnboardingNotification implements PnfdManagementNotification {
    ...
    private String id;
    @Schema(name = "Notification Type", required = true, description = "Discriminator for the different notification types. Shall be set to \"PnfdOnboardingNotification\" for this notification type.")
