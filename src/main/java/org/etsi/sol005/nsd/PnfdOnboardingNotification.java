...
/**
 * Represents a PNFD management notification, which informs the receiver of the successful on-boarding of a PNFD.
 * It shall comply with the provisions defined in table 5.5.2.13-1. The support of this notification is mandatory.
 * The notification is triggered when a new PNFD is on-boarded.
 */
@Data
@JsonInclude(value = JsonInclude.Include.NON_EMPTY, content = JsonInclude.Include.NON_NULL)
@JsonIgnoreProperties(ignoreUnknown = true)
@ApiModel(description = "Represents a PNFD management notification, which informs the receiver of the successful on-boarding of a PNFD.")
public class PnfdOnboardingNotification implements PnfdManagementNotification {
    public static final String TYPE = "PnfdOnboardingNotification";
    ...
    private String id;
    @ApiModelProperty(name = "Notification Type", required = true, notes = "Discriminator for the different notification types. Shall be set to \"PnfdOnboardingNotification\" for this notification type.")
